...
. In your Jupyter environment, locate the `0_sandbox.ipynb` file in the directory `test-drive/fraud-detection`.
. Double-click it to launch the notebook. It opens in a new tab in the content section of the environment. 
+
...
* If you want to learn more about notebooks, go to https://jupyter.org/[the Jupyter site].
