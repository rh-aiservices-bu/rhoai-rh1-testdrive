...
. Optionally, view the provided Python code in your Jupyter environment by navigating to the `test-drive` project's `fraud-detection/pipeline` directory. It contains the following files:
+
...
+
The generated `5_get_data_train_upload.yaml` file is located in the `fraud-detection-notebooks` directory.
