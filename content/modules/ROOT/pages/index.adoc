...
In this {deliverable}, you will start with the basics of {productname-short}, and end with some of the newest and most advanced features.
...
// TODO does this still hold true? still using Caikit?
