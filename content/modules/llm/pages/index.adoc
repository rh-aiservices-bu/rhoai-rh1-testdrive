...
Today, we'll be using Google's https://huggingface.co/google/flan-t5-small[flan-t5-small] because of compatibility, small size, and small requirements (no gpu).  It is not a good model, but the process is the same for any of the compatible models.
